...
class CityscapesSegmentation(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            ...
            _img = Image.open(img_path).convert('RGB').resize(self.args.image_size)
            _depth = Image.open(disp_path).resize(self.args.image_size)
            _target = Image.open(lbl_path).resize(self.args.image_size)
